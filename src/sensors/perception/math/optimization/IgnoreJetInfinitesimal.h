...
template <typename T>
inline ARVR_HOST_DEVICE double IgnoreJetInfinitesimal(const T& j) {
  static_assert(
...
inline ARVR_HOST_DEVICE double IgnoreJetInfinitesimal(double j) {
  return j;
}

inline ARVR_HOST_DEVICE float IgnoreJetInfinitesimal(float j) {
  return j;
}

template <typename Derived>
inline ARVR_HOST_DEVICE

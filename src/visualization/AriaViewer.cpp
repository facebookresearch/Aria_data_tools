...
void AriaViewer::run() {
 ...
 // setup a loggers to show trajectory signals
 ...
 //pangolin::Var<bool> showTrajectory(prefix + ".Trajectory", true, true);
 // IMU
 ...
 while (!pangolin::ShouldQuit()) {
   ...
   //plotTajectory.Show(showTrajectory);

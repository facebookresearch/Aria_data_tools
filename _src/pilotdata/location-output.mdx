...
To give co-location information across different recordings, trajectories from the same [location](/pilotdata/everyday/everyday.md) are all aligned into the same world frame. Trajectories from the same [sequence](/pilotdata/everyday/scripts.md) are all aligned into the same world frame. The origin of the world frames are arbitrarily defined. The gravity acceleration vector always points up in the z axis of the world frame.

...
The Everyday Activities Activities section of this dataset has been updated to align with [Project Aria Tools](https://facebookresearch.github.io/projectaria_tools/docs/intro) file formatting and contains improved Machine Perception Services (MPS) and re-relased as the [Aria Everyday Activities (AEA) dataset](https://www.projectaria.com/datasets/aea/).

* [Aria Everyday Activities Documentation](https://facebookresearch.github.io/projectaria_tools/docs/open_datasets/aria_everyday_activities_dataset)

## Aria Pilot Dataset Overview

The Aria Pilot dataset is the first open dataset captured using [Project Aria](https://projedctaria.com), Meta’s research device used for accelerating machine perception and AI research, developed at Reality-Labs Research.
...
Please go to [Aria Everyday Activities Documentation](https://facebookresearch.github.io/projectaria_tools/docs/open_datasets/aria_everyday_activities_dataset) in [Project Aria Tools](https://facebookresearch.github.io/projectaria_tools/docs/intro) for the most up to date version of this dataset.
